...
public class StarWarsGitProviderExternalConfigurationTest {
    ...
    public static void recordServerInteractions() {
        ...
        embeddedService.addExpectation(
            onRequestTo("/rest/planet/orbital/biggest")
                .withMethod(ClientDriverRequest.Method.GET),
            giveResponseAsBytes(StarWarsGitProviderExternalConfigurationTest.class.getResourceAsStream("/server.json"),
